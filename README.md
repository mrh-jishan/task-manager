...
The backend public URL is for direct API access and for local frontend-to-remote-backend testing. Until the frontend ingress is fully live in each environment, the frontend can also be pointed at the backend ingress URL directly.
